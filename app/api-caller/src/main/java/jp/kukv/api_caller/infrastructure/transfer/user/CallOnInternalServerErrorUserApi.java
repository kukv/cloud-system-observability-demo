...
@Repository
class CallOnInternalServerErrorUserApi implements ApiCallRepository {
  ...
  CallOnInternalServerErrorUserApi(
      RestClientFactory factory, @Qualifier("userApi") Endpoint endpoint) {
